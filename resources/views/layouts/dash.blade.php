...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 collapse-left">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Jaramah Inc. </span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href='{{route('cardcat')}}' class="nav-link">
              <p>
                 التصنيفات              </p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href='{{route('cardvalue')}}' class="nav-link">
            كود الكارت
            </a>
          </li>
          <li class="nav-item">
            <a href='{{route('cardsremaining')}}' class="nav-link">
            الكروت المتبقية
            </a>
          </li>
          <li class="nav-item">
            <a href='{{route('legend')}}' class="nav-link">
            ليجيند
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href='{{route('pubg')}}' class="nav-link">
            ببجي
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href='{{route('freefire')}}' class="nav-link">
            فريفاير
            </a>
          </li>
                    ...
                    <li class="nav-item">
                      <a href='{{route('rechargelog')}}' class="nav-link">
                      دليل شحن الرصيد
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href='{{route('manualrechargelog')}}' class="nav-link">
                     دليل شحن الالعاب
                      </a>
                    </li>

                    <li class="nav-item">
                      <a href='{{route('pendingrecharges')}}' class="nav-link">
